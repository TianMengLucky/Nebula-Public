...
public class DragAndDropBehaviour : MonoBehaviour
{
    ...
    private UnityDragAndDropHook.DroppedFilesEvent? OnGetFilePath;

    static DragAndDropBehaviour()
    {
        ClassInjector.RegisterTypeInIl2Cpp<DragAndDropBehaviour>();
    }
    ...
    static public void Show(Transform? parent, GetFilePathEvent onGetFilePath)
    {
        ...
        var accepter = obj.AddComponent<DragAndDropBehaviour>();
    ...
    public void Awake()
    {
        ...
        UnityDragAndDropHook.OnDroppedFiles += OnGetFilePath;
